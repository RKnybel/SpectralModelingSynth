...
float h_freqs[50] = { 1000, 2000, 2000, 2000, 2000, 2000, 2000, 2000, 2000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000 };
float* d_freqs;
...
void prepareSMS() {
    ...
    printError();
    cudaMalloc((void**) &d_samples, sizeof(float) * numSamples);
    printError();
    ...
    printError();
    cudaMemcpy(d_samples, h_samples, sizeof(float) * numSamples, cudaMemcpyHostToDevice);
...
void renderBufferNewSMS() {
    sinusoidal_method1 <<<2, 441 >>> (d_freqs, d_amps, d_samples, d_partialEnergy, 0, 0.01);
...
int main()
{
    ...
    for (int i = 0; i < 100; i++) {
        ...
        std::cout << (long long)us_int.count() << std::endl;
    }
